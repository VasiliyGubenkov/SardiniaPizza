...
class PizzaAdmin(admin.ModelAdmin):
    ...
    list_display_links = ('name', 'description', 'size', 'price', 'discount')
...
class UserAdmin(admin.ModelAdmin):
    ...
    list_display_links = ('user_login', 'name', 'surname', 'phone', 'email')
...
class BasketAdmin(admin.ModelAdmin):
    ...
    list_display_links = ('user', 'good', 'price_of_good', 'quantity_of_good')
...
class OrderAdmin(admin.ModelAdmin):
    ...
    list_display_links = ('address_of_delivery', 'content_of_order', 'amount', 'payment_statuses')
